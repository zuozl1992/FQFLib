...
bool FQFDemuxThread::getMusicTitlePage(unsigned char **data, int *size)
{
    return demux->getMusicTitlePage(data,size);
}

void FQFDemuxThread::freeBuffer(unsigned char **buf)
{
